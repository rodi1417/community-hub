  ...
  $(function(){
    ...
    if(typeof vm_video !== "undefined"){
  		if(vm_video!==undefined && vm_video!=="" && vm_video!==" "){
  			addHeroVideo();
  			$(".hero-video")
        .append('<iframe class="fullvid" id="myVid" width="1280" height="720" src="https://www.youtube.com/embed/2-M3A1nB4So?autoplay=1&mute=1&rel=0&playlist=2-M3A1nB4So&loop=1" frameborder="0" volume="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" style="width: 1729px; height: 974.75px;"></iframe>');
